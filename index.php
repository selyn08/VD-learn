...
<div class="relative min-h-screen md:flex">
    ...
    <div class="absolute top-4 left-4 z-20 md:hidden">
        <button id="sidebar-toggle" class="text-gray-500 hover:text-white focus:outline-none focus:text-white">
    ...
    <!-- Sidebar -->
    <aside id="sidebar" class="fixed inset-y-0 left-0 w-80 flex flex-col bg-background-light dark:bg-background-dark border-r border-gray-200 dark:border-gray-800 transform -translate-x-full md:relative md:translate-x-0 transition-transform duration-300 ease-in-out z-30">
        <div class="p-4 mt-10 md:mt-0">
            <div class="relative">
